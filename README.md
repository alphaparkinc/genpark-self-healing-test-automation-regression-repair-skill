# genpark-self-healing-test-automation-regression-repair-skill
...
> **GenPark AI Agent Skill** -- Self-healing test automation framework repairing broken UI selectors and generating fix PRs (Qodex style)
